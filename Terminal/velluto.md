# `connect velluto --password=Grt5617hIf`

> Connecting to Velluto private server...  
> Authentication successful.  
> Access granted. Loading directory structure...  
> /velluto  
> ├── [README.txt](./velluto/)  
> ├── [security/](./velluto/security/)  
> │&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├── [access_violation_report.txt](./velluto/security/access_violation_report.txt)  
...
> ├── [incidents/](./velluto/incidents/)  
> │&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└── [external_pressure_cases.txt](./velluto/incidents/external_pressure_cases.txt)  
> ├── [correspondence/](./velluto/correspondence/)  
> │&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└── [private_requests_thread.txt](./velluto/correspondence/private_requests_thread.txt)  
> ├── [finance/](./velluto/finance/)  
> │&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└── [loss_report_q.txt](./velluto/finance/loss_report_q.txt)  
> ├── [archive/](./velluto/archive/)  
